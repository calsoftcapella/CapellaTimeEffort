...
public class UserServiceImpl implements UserService {
	...
	public List<User> getUserContactDetails() {
		UserDao dao = Factory.getDao();
		return dao.getUserContactDetails();
	}

	@Override
	public List<ProjectTaskForm> getProjectTaskDetails(int userId) {
		UserDao dao = Factory.getDao();
		List<ProjectTaskDetails> list = dao.getProjectTaskDetails(userId);
		for (ProjectTaskDetails projectTaskDetails : list) {
			logger.info("Jaishu ProjectTaskDetails->"+projectTaskDetails.getTaskDesc());
		}
		return null;
	}
