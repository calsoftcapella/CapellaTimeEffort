			...
			<logic:present name="updateUserDetails" scope="request">
				...
				<table id="userInfoTableId" cellpadding="5px" class="hovertable">
					...
					<tbody>
						...
						<tr>
							<td><span
								style="font-size: 10px; color: red; font-weight: bolder;">*</span> Capella Id:</td>
						...
						<tr>
							<td>Role In Timesheet-present:</td>
						...
						<tr>
							<td><span
								style="font-size: 10px; color: red; font-weight: bolder;">*</span> Skype Id:</td>
							<td>
								<html:text name="updateUserDetails" property="skypeId" styleId="skype_id" 
									title="Edit Skype Id" maxlength="25" />
								<span id="skypeId_error" style="font-family: verdana, arial, sans-serif; font-size: 11px; color: red;"></span>
							</td>
						</tr>
						<tr>
							<td><span
								style="font-size: 10px; color: red; font-weight: bolder;">*</span> Location:</td>
							<td><html:text name="updateUserDetails" property="location"
									styleId="location_id" title="Edit Resource Location"
									maxlength="25" />
								<span id="location_error" style="font-family: verdana, arial, sans-serif; font-size: 11px; color: red;"></span>
							</td>
						</tr>
						<tr>
							<td></td>
				...
				<logic:present name="userDetailsAfterSaving" scope="request">
					...
					<table id="userInfoTableId" class="hovertable" cellpadding="5px">
						...
						<tbody>
							...
							<tr>
								<td>Role In Timesheet - not present:</td>
								<td><html:select name="userDetailsAfterSaving"
