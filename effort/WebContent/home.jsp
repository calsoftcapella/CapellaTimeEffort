	...
	<div style="margin-left: 40px; margin-right: 30px;">
		<div>
			...
			<table align="left"
				...
				<tr>
					<td><div id="blinkIt" style="font-size: 14px;font-weight: bolder;font-family: cursive;display:none;">New Openings:</div>
								<script type="text/javascript">
									blinkFont();
								</script>
							<ul style="display: none;">
								<li><a href=".##" id="open_position_link" style="color: rgb(0, 60, 205);display:none;"> Apollo ODC-Open Positions</a></li>
							</ul>
							 <div id="element_to_pop_up" style="padding-left: 40px;display: none;">
							 <table style="width: 760px;">
							 <tr>
							  <td width="550px"><img src="img/img_logo_CalsoftLabs.jpg" style="padding-top: 14px;"/></td>
						...
						<div class="boxMess">
							...
							<ul>
								...
								<li>Add sufficient details to substantiate the effort spent
									against a task.</li>
								<li>Enter CRM ID and V1 story id for project related tasks.
