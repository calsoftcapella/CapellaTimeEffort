...
function addRow(tableID, missingDate){ 
	...
	if(missingDate==''){
		...
		+" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></textarea>";
		commentsHtml = "<textarea name=\"comments\" title=\"Add Comments here.\" id=\"comments"+count+"\" rows=\"2\" cols=\"2\" value=\"\" "
		+" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></textarea>";
	}
	else{
		strHtml1 = "<INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" "
		...
		strHtml5 = "<textarea name=\"task_description\" title=\"Add description here.\" id=\"des_id"+count+"\" rows=\"2\" cols=\"2\" value=\"\" "
		+" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">Effort not entered.</textarea>";
		commentsHtml = "<textarea name=\"comments\" title=\"Add Comments here.\" id=\"comments"+count+"\" rows=\"2\" cols=\"2\" value=\"\" "
		+" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></textarea>";
	}
	...
	td2.id = "td_st";
	var strHtml2 = "<SELECT NAME=\"status\" id=\"status"+count+"\" title=\"Select appropriate category.\" onchange=\"changeDynamicTextBox(this);\" style=\"width: 60px;font-family: verdana, arial, sans-serif;font-size: 11px;\">"
	...
	// create table cell 6 - for comments
	var commentsTD = tRow.insertCell(5);
	commentsTD.id = "td_comments";
	commentsTD.innerHTML = commentsHtml;
	
	// create table cell 6
	var td6 = tRow.insertCell(6);
	...
	// create table cell 7 - for planned date and time.
	var planTimeTD = tRow.insertCell(7);
	planTimeTD.id = "td_planTime";
	var planTimeHtml = "<INPUT TYPE=\"text\" NAME=\"plan time\" title=\"eg:HH.MM, HH:MM\" id=\"planTime"+count+"\"  SIZE=\"5\" MAXLENGTH=\"5\" value=\"\" "
	+" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">";
	planTimeTD.innerHTML = planTimeHtml;
		
	// create table cell 8
	var td7 = tRow.insertCell(8);
	var strHtml7 = "<INPUT TYPE=\"text\" NAME=\"actual time\" title=\"eg:HH.MM, HH:MM\" id=\"actualTime"+count+"\"  SIZE=\"5\" MAXLENGTH=\"5\" value=\"\" "
	+" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">";
	td7.innerHTML = strHtml7;
	// create table cell 9
	var td8 = tRow.insertCell(9);
...
function callAjax(currentObject){  
	...
	for (var p = 0; p < radioLength; p++){
		if(nCell[6].getElementsByTagName('input')[p].checked){
			work_status = nCell[6].getElementsByTagName('input')[p].value;
		}
	}
	...
	var timeValue = nCell[7].firstChild.value;
	var actualTimeValue = nCell[8].firstChild.value;
	if(doValidation(date, status, backlog_id, task_id, timeValue, idVal)) {  	
		timeValue = getParsedTime(timeValue);
		actualTimeValue = getParsedTime(actualTimeValue);
		var selectOption = document.getElementById("userId"); 
		var userId = 0;
		if(selectOption!=null){
			userId = $('#userId option:selected').val();
		}   
		taskJson.push({ "date": date, "status": status, "backlog_id": backlog_id, "task_id" :task_id,"task_description":task_description,"comments" : comments,"work_status":work_status, "time":timeValue,"actualTime":actualTimeValue, "userId":0});
		$.ajax({
			type: "POST",
			...
			success: function(response){
				...
				{
					if(status=="Leave"||status=="Half Day"){
						$('#'+idVal).html("<td>"+date+"</td><td>"+status+"</td><td>"+backlog_id+"</td><td>"+task_id+"</td><td>"+task_description+"</td><td>"+comments+"</td><td>"+capitalizeWorkStatus+"</td>"
								+"<td style=\"color: #FF0000;\">"+timeValue+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+response+")' style='cursor: pointer;'/></td><td>"
						...
						$('#'+idVal).html("<td>"+date+"</td><td>"+status+"</td><td>"+backlog_id+"</td><td>"+task_id+"</td><td>"+task_description+"</td><td>"+comments+"</td><td>"+capitalizeWorkStatus+"</td>"
								+"<td style=\"color: #0000CD;\">"+timeValue+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+response+")' style='cursor: pointer;'/></td>"
						...
						$('#'+idVal).html("<td style=\"color: #008000;\">"+date+"</td><td style=\"color: #008000;\">"+status+"</td><td style=\"color: #008000;\">"+backlog_id+"</td>"
								+"<td style=\"color: #008000;\">"+task_id+"</td><td style=\"color: #008000;\">"+task_description+"</td><td>"+comments+"</td><td style=\"color: #008000;\">"+capitalizeWorkStatus+"</td>"
								+"<td style=\"color: #008000;\">"+timeValue+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+response+")' style='cursor: pointer;'/></td>"
								+"<td><img src='img/delete1.png' title=\"Click to delete entry.\" onclick='onDelete(\"taskAction1.do?method=delete&id="+response+"\", this)' style='cursor: pointer;' /></td>");
					}
					else {
						$('#'+idVal).html("<td>"+date+"</td><td>"+status+"</td><td>"+backlog_id+"</td><td>"+task_id+"</td><td>"+task_description+"</td><td>"+comments+"</td><td>"+capitalizeWorkStatus+"</td>"
								+"<td>"+timeValue+"</td><td>"+actualTimeValue+"</td>"
...
{  
	...
	if(editFieldStatus>0){
		...
		var comments = nCell[5].innerHTML;
		var workStatus = nCell[6].innerHTML;
		var planTime = nCell[7].innerHTML;
		var actualTime = nCell[8].innerHTML;
		if(status=='Half Day'||status=='Down Time'||status=='Comp off'||status=='Travel'){
			if(workStatus.trim()=='Home'){
				$('#'+idVal).html("<td id=\"td_dt\" width=\"80px\"><INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" value='"+date+"' STYLE=\"height:4;width: 65px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></td>"
						...
						+"<option value=\"Travel\">Travel</option>"
						+"</SELECT></td>"
						+"<td id=\"td_back\"><INPUT TYPE=\"text\" id=\"backlog_id\" disabled=\"disabled\" title=\"Enter BacklogId.\" NAME=\"backlog_id\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+backlog_id+"></td>"
						+"<td id=\"td_task\"><INPUT TYPE=\"text\" id=\"task_id\" disabled=\"disabled\" NAME=\"task_id\" title=\"Enter TaskId.\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+task_id+" ></td>"
						+"<td id=\"td_des\"><textarea name=\"task_description\" title=\"Add description here.\" id=\"des_id\" value="+task_description+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+task_description+"</textarea></td>"
						+"<td id=\"td_comments\"><textarea name=\"comments\" title=\"Add comments here.\" id=\"comments\" value="+comments+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+comments+"</textarea></td>"
						...
						+"<td id=\"td_tm\"><INPUT TYPE=\"text\" NAME=\"planTime\" title=\"eg:HH.MM, HH:MM\" id=\"planTime\"  SIZE=\"5\" MAXLENGTH=\"5\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+planTime+"></td>"
						+"<td id=\"td_tm\"><INPUT TYPE=\"text\" NAME=\"actualTime\" title=\"eg:HH.MM, HH:MM\" id=\"actualTime\"  SIZE=\"5\" MAXLENGTH=\"5\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+actualTime+"></td>"
			...
			if(workStatus.trim()=='Home'){
				$('#'+idVal).html("<td id=\"td_dt\" width=\"80px\"><INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" value='"+date+"' STYLE=\"height:4;width: 65px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></td>"
						...
						+"<td id=\"td_back\"><INPUT TYPE=\"text\" id=\"backlog_id\" disabled=\"disabled\" title=\"Enter BacklogId.\" NAME=\"backlog_id\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+backlog_id+"></td>"
						+"<td id=\"td_task\"><INPUT TYPE=\"text\" id=\"task_id\" disabled=\"disabled\" NAME=\"task_id\" title=\"Enter TaskId.\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+task_id+" ></td>"
						+"<td id=\"td_des\"><textarea name=\"task_description\" title=\"Add description here.\" id=\"des_id\" disabled=\"disabled\" value="+task_description+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+task_description+"</textarea></td>"
						+"<td id=\"td_comments\"><textarea name=\"comments\" title=\"Add comments here.\" id=\"comments\" value="+comments+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+comments+"</textarea></td>"
						+"<td id=\"td_workStatus\" style=\"height: 100px;width: 200px;font-family: verdana, arial, sans-serif;font-size: 11px;\"><input type=\"radio\" id=\"work_status1"+count+"\" title=\"Pick Effort From\" name=\"work_status\" value=\"office\"> Office"
						+"<input type=\"radio\" id=\"work_status2"+count+"\" title=\"Pick Effort From\" name=\"work_status\" value=\"home\" checked>Home</td>"
						+"<td id=\"td_tm\"><INPUT TYPE=\"text\" NAME=\"planTime\" title=\"eg:HH.MM, HH:MM\" id=\"planTime\"  SIZE=\"5\" MAXLENGTH=\"5\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+planTime+"></td>"
			...
			if(workStatus.trim()=='Home'){
				$('#'+idVal).html("<td id=\"td_dt\" width=\"80px\"><INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" value='"+date+"' STYLE=\"height:4;width: 65px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></td>"
						...
						+"<option value=\"Travel\">Travel</option>"
						+"</SELECT></td>"
						+"<td id=\"td_back\"><INPUT TYPE=\"text\" id=\"backlog_id\" title=\"Enter BacklogId.\" NAME=\"backlog_id\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+backlog_id+"></td>"
						+"<td id=\"td_task\"><INPUT TYPE=\"text\" id=\"task_id\" NAME=\"task_id\" title=\"Enter TaskId.\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+task_id+" ></td>"
						+"<td id=\"td_des\"><textarea name=\"task_description\" title=\"Add description here.\" id=\"des_id\" value="+task_description+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+task_description+"</textarea></td>"
						+"<td id=\"td_comments\"><textarea name=\"comments\" title=\"Add comments here.\" id=\"comments\" value="+comments+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+comments+"</textarea></td>"
						+"<td id=\"td_workStatus\" style=\"height: 100px;width: 200px;font-family: verdana, arial, sans-serif;font-size: 11px;\"><input type=\"radio\" id=\"work_status1"+count+"\" title=\"Pick Effort From\" name=\"work_status\" value=\"office\"> Office"
						+"<input type=\"radio\" id=\"work_status2"+count+"\" title=\"Pick Effort From\" name=\"work_status\" value=\"home\" checked>Home</td>"
				...
				$('#'+idVal).html("<td id=\"td_dt\" width=\"80px\"><INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" value='"+date+"' STYLE=\"height:4;width: 65px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></td>"
						+"<td id=\"td_st\">"
						+"<SELECT NAME=\"status\" id=\"status\" title=\"Select appropriate category.\" onchange=\"changeDynamicTextBox(this);\" style=\"width: 60px;font-family: verdana, arial, sans-serif;font-size: 11px;\">"
						+"<option value=\""+status+"\">"+status+"</option>"
						+"<option value=\"Code Review\">Code Review</option>"
						+"<option value=\"Comp off\">Comp off</option>"
						+"<option value=\"Development\">Development</option>"
...
function callAjaxEditSave(r,id){ 
	...
	var comments = nCell[5].firstChild.value;
	var taskJson = new Array();
	var workStatus = nCell[6].firstChild.value;
	var radioLength = nCell[6].getElementsByTagName('input').length;    	
	for (var p = 0; p < radioLength; p++){
		if(nCell[6].getElementsByTagName('input')[p].checked){
			workStatus = nCell[6].getElementsByTagName('input')[p].value;
		}
	}
	var capitalizeWorkStatus = null;
	if(workStatus=='home'){
	...
	var time = nCell[7].firstChild.value;
	var actualTimeValue = nCell[8].firstChild.value;
	if(doValidation(date, status, backlog_id, task_id, time, idVal)) {  	
		...
		taskJson.push({ "date": date, "status": status, "backlog_id": backlog_id, "task_id" :task_id,"task_description":task_description,
			"comments" : comments,"work_status":workStatus, "time":time,"actualTime":actualTimeValue,"id":id, "userId":userId});
		$.ajax({
			type: "GET",
			...
			success: function(response){
				...
				if(response=="Invalid time Entry"){
					...
					if(status=="Leave"||status=="Half Day"){
						$('#'+idVal).html("<td>"+date+"</td><td>"+status+"</td><td>"+backlog_id+"</td><td>"+task_id+"</td><td>"+task_description+"</td><td>"+comments+"</td><td>"+capitalizeWorkStatus+"</td>"
								+"<td style=\"color: #FF0000;\">"+time+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+id+")' style='cursor: pointer;'/></td>"
								+"<td><img src='img/delete1.png' title=\"Click to delete entry.\" onclick='onDelete(\"taskAction1.do?method=delete&id="+id+"\", this)' style='cursor: pointer;' /></td>");        		 
					}
					else if(status=="Public holiday"){
						$('#'+idVal).html("<td>"+date+"</td><td>"+status+"</td><td>"+backlog_id+"</td><td>"+task_id+"</td><td>"+task_description+"</td><td>"+comments+"</td><td>"+capitalizeWorkStatus+"</td>"
								+"<td style=\"color: #0000CD;\">"+time+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+id+")' style='cursor: pointer;'/></td>"
								+"<td><img src='img/delete1.png' title=\"Click to delete entry.\" onclick='onDelete(\"taskAction1.do?method=delete&id="+id+"\", this)' style='cursor: pointer;' /></td>");
					}
					else if(status=="Comp off"){
						$('#'+idVal).html("<td style=\"color: #008000;\">"+date+"</td><td style=\"color: #008000;\">"+status+"</td><td style=\"color: #008000;\">"+backlog_id+"</td><td style=\"color: #008000;\">"+task_id+"</td><td style=\"color: #008000;\">"+task_description+"</td><td>"+comments+"</td><td style=\"color: #008000;\">"+capitalizeWorkStatus+"</td>"
								+"<td style=\"color: #008000;\">"+time+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+id+")' style='cursor: pointer;'/></td>"
								+"<td><img src='img/delete1.png' title=\"Click to delete entry.\" onclick='onDelete(\"taskAction1.do?method=delete&id="+id+"\", this)' style='cursor: pointer;' /></td>");
					}
					else
					{
						$('#'+idVal).html("<td>"+date+"</td><td>"+status+"</td><td>"+backlog_id+"</td><td>"+task_id+"</td><td>"+task_description+"</td><td>"+comments+"</td><td>"+capitalizeWorkStatus+"</td>"
								+"<td>"+time+"</td><td>"+actualTimeValue+"</td><td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+id+")' style='cursor: pointer;'/></td>"
								+"<td><img src='img/delete1.png' title=\"Click to delete entry.\" onclick='onDelete(\"taskAction1.do?method=delete&id="+id+"\", this)' style='cursor: pointer;' /></td>");
					}
...
function doValidation(date, status, backlog_id, task_id, time, currentRowId){
	...
	if(date == ""){
		...
		document.getElementById(currentRowId).getElementsByTagName('td')[1].innerHTML="<SELECT NAME=\"status\" id=\"status\" title=\"Select appropriate category.\" onchange=\"changeDynamicTextBox(this);\" style=\"width: 60px;font-family: verdana, arial, sans-serif;font-size: 11px;border: 1 solid;border-color:red;background-color:#FFFFE7;\">"
			+"<option value=\"\">Select</option>"
			+"<option value=\"Code Review\">Code Review</option>"
			+"<option value=\"Comp off\">Comp off</option>"
			+"<option value=\"Development\">Development</option>"
		...
		document.getElementById(currentRowId).getElementsByTagName('td')[1].innerHTML="<SELECT NAME=\"status\" id=\"status\" title=\"Select appropriate category.\" onchange=\"changeDynamicTextBox(this);\" style=\"width: 60px;font-family: verdana, arial, sans-serif;font-size: 11px;border: 1 solid;border-color: #3C3CFF;;\">"
			+"<option value=\""+status+"\">"+status+"</option>"
			+"<option value=\"Code Review\">Code Review</option>"
			+"<option value=\"Comp off\">Comp off</option>"
			+"<option value=\"Development\">Development</option>"
		...
		document.getElementById(currentRowId).getElementsByTagName('td')[2].innerHTML="<INPUT TYPE=\"text\" id=\"backlog_id\" title=\"Enter BacklogId.\" "
			+" NAME=\"backlog_id\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;border-color:red;background-color:#FFFFE7;\" "
			+" value="+backlog_id+" >"
		...
		document.getElementById(currentRowId).getElementsByTagName('td')[1].innerHTML="<SELECT NAME=\"status\" id=\"status\" title=\"Select appropriate category.\" onchange=\"changeDynamicTextBox(this);\" style=\"width: 60px;font-family: verdana, arial, sans-serif;font-size: 11px;border: 1 solid;border-color: #3C3CFF;;\">"
			...
			+"</SELECT>";
		document.getElementById(currentRowId).getElementsByTagName('td')[2].innerHTML="<INPUT TYPE=\"text\" id=\"backlog_id\" title=\"Enter BacklogId.\" "
			+" NAME=\"backlog_id\" SIZE=\"5\" MAXLENGTH=\"20\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" "
			+" value="+backlog_id+">";
	...
	for(var i=0;i<=totalRow;i++) {
		...
		if(input.length=='6'){
			...
			if(edit_id!=null){
				...
				var time = nCell[7].firstChild.value;
				var actualTime = nCell[8].firstChild.value;
				if(doValidation(date, status, backlog_id, task_id, time, currentRowId)){
					...
					taskJson.push({ "date": date, "status": status, "backlog_id": backlog_id, "task_id" :task_id,"task_description":task_description,"comments" : comments,"work_status":work_status, "time":time,"actualTime":actualTimeValue,"currentRowId":currentRowId, "userId":userId});
				...
				for(var i=0;i<taskJson.length;i++){						        	   
					...
					if(id=='0' && taskJson[i].work_status=='office'){
						$('#'+taskJson[i].currentRowId).html("<td><INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker"+i+"\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" "
								...
								+"<td><SELECT NAME=\"status\" id=\"status\" title=\"Select appropriate category.\" onchange=\"changeDynamicTextBox(this);\" style=\"width: 60px;font-family: verdana, arial, sans-serif;font-size: 11px;\">"
								...
								+" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\"></textarea></td>"
								+"<td id=\"td_comments\"><textarea name=\"comments\" title=\"Add comments here.\" id=\"comments\" value="+taskJson[i].comments+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+taskJson[i].comments+"</textarea></td>"
								...
								+"<td id=\"td_tm\"><INPUT TYPE=\"text\" NAME=\"planTime\" title=\"eg:HH.MM, HH:MM\" id=\"planTime\"  SIZE=\"5\" MAXLENGTH=\"5\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+taskJson[i].planTime+"></td>"
								+"<td id=\"td_tm\"><INPUT TYPE=\"text\" NAME=\"actualTime\" title=\"eg:HH.MM, HH:MM\" id=\"actualTime\"  SIZE=\"5\" MAXLENGTH=\"5\" STYLE=\"height:4;width: 40px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\" value="+taskJson[i].actualTime+"></td>"
						...
						$('#'+taskJson[i].currentRowId).html("<td><INPUT TYPE=\"text\" NAME=\"task_date\" title=\"Click to pick date from calendar.\" id=\"popupDatepicker"+i+"\" readonly=\"true\" SIZE=\"5\" MAXLENGTH=\"10\" "
								...
								+" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+taskJson[i].task_description+"</textarea></td>"
								+"<td id=\"td_comments\"><textarea name=\"comments\" title=\"Add comments here.\" id=\"comments\" value="+taskJson[i].comments+" rows=\"2\" cols=\"2\" STYLE=\"width: 85px;height: 100px;border: 1 solid;margin:0;font-family: verdana, arial, sans-serif;font-size: 11px;\">"+taskJson[i].comments+"</textarea></td>"
						...
						if(taskJson[i].status=="Leave"||taskJson[i].status=="Half Day"){	
							$('#'+taskJson[i].currentRowId).html("<td>"+taskJson[i].date+"</td><td>"+taskJson[i].status+"</td>"
									+"<td>"+taskJson[i].backlog_id+"</td><td>"+taskJson[i].task_id+"</td><td>"+taskJson[i].task_description+"</td><td>"+taskJson[i].comments+"</td>"
									+"<td>"+capitalizeWorkStatus+"</td><td style=\"color: #FF0000;\">"+taskJson[i].plannedTime+"</td><td>"+taskJson[i].actualTimeValue+"</td>"
							...
							$('#'+taskJson[i].currentRowId).html("<td style=\"color: #008000;\">"+taskJson[i].date+"</td><td style=\"color: #008000;\">"+taskJson[i].status+"</td>"
									+"<td style=\"color: #008000;\">"+taskJson[i].backlog_id+"</td><td style=\"color: #008000;\">"+taskJson[i].task_id+"</td><td style=\"color: #008000;\">"+taskJson[i].task_description+"</td><td>"+taskJson[i].comments+"</td>"
									+"<td style=\"color: #008000;\">"+capitalizeWorkStatus+"</td><td style=\"color: #FF0000;\">"+taskJson[i].plannedTime+"</td><td>"+taskJson[i].actualTimeValue+"</td>"
									+"<td><img src='img/edit.png' title=\"Click to edit entry.\" onclick='editRowEntry(this,"+id+")' style='cursor: pointer;'/></td>"
									+"<td><img src='img/delete1.png' title=\"Click to delete entry.\" onclick='onDelete(\"taskAction1.do?method=delete&id="+id+"\", this)' style='cursor: pointer;' /></td>");						        
						}
						else{
