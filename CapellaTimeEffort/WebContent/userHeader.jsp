				...
				<table border="0">
					<tr>
						<td valign="top" height="40%" align="left"><img
							src="img/img_logo_CalsoftLabs.jpg" style="padding-top: 14px;"/></td>
					</tr>
				</table>
			</td>
										...
										<table>
											<tr valign="bottom">
												...
												<td><a
													...
													class="testLink" style="color: #003CCD; display:none;">Performance
														Log</a></td>
												<td><a
													href="userContactDetails.do?method=getUserContactDetails"
													id="a9" class="testLink"
													onclick="changeLinkCSS(this);submitReport('userContactDetails.do?method=getUserContactDetails');"
													style="color: #003CCD">Team Details</a></td>
											</tr>
										</table>
									</logic:present>
									<logic:notPresent name="clientRole" scope="session">
										<table>
											<tr valign="bottom">
												...
												<td><a href="newProjectTask.do?method=initialProjectTaskDetails"
													id="a1"
													onclick="changeLinkCSS(this);submitReport('newProjectTask.do?method=initialProjectTaskDetails');"
													class="testLink" style="color: #003CCD;">Task Details</a> |</td>
									...
									<table width="615px;">
										<tr valign="bottom">
											...
											<td><a
												...
												id="a7"
												onclick="changeLinkCSS(this);submitReport('performanceLog.do?method=getSelectedperiodList');"
												class="testLink" style="color: #003CCD;display:none;">Performance Log</a>
												|</td>
											<td><a
