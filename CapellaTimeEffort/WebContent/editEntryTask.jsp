...
<br>
       <logic:empty name="displayTaskEntry" scope="request">
		...
		{
		%>				
<TD >CRM ID:<html:text disabled="true" size="6" property="backlog_id" value="<%=taskform.getBacklog_id() %>"  title=" This entry is for theBacklogId of task that you working." styleId="disableBacklog" style="font-family: verdana, arial, sans-serif;font-size: 11px;" ></html:text></TD>						
<TD>V1 story id:<html:text disabled="true" size="6" property="task_id" value="<%=taskform.getTask_id() %>" title=" This entry is for the TaskID of task that you working."  styleId="disableTask" style="font-family: verdana, arial, sans-serif;font-size: 11px;"></html:text></TD>
		<%}
		else
		{
		%>							
<TD>CRM ID:<html:text  size="6" property="backlog_id" value="<%=taskform.getBacklog_id() %>"  title=" This entry is for theBacklogId of task that you working." styleId="disableBacklog" style="font-family: verdana, arial, sans-serif;font-size: 11px;" ></html:text></TD>						
<TD>V1 story id:<html:text  size="6" property="task_id" value="<%=taskform.getTask_id() %>" title=" This entry is for the TaskID of task that you working."  styleId="disableTask" style="font-family: verdana, arial, sans-serif;font-size: 11px;"></html:text></TD>
		<%} 		
			...
			<div
				...
				<table class="hovertable" border="10" width="760px">
					<tr>
						...
						<th style="width:5pc"><h4>CRM ID</h4></th>
						<th style="width:0pc"><h4>V1 story id</h4></th>
